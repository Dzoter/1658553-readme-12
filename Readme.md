<p>
Проект написанный на процедурке с попыткой реализации MVC модели.
Все условные контроллеры находятся в главной директории проекта.
Модели в директории models, в них реализованы запросы в бд.
в настоящий момент я бы реализовал этот проект иначе.
</p>
